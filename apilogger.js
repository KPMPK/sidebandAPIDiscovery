...
// const webTargetIP = 'ves-io-a98d2cb2-7b07-4e59-8843-e72eb4565392.ac.vh.ves.io';
const webTargetPort = 80;
const webServerPort = 3001;
const logServerPort = 15515;
// var logIdx = 0;
var logEntries = [];
var vipTargets = [];
...
function startSyslog() {
    ...
    logger.debug("create server");
        ...
        logger.debug('server connected', socket.authorized ? 'authorized' : 'unauthorized');
        ...
        try {
            if (typeof req.headers['logidx'] == 'undefined') {
                ...
                if (logEntry) {
                    ...
                    //res.end(logResponse.payload); mean 29sep
                    const Data = querystring.unescape(logResponse.payload);                 
